...
class OAuth2Validator(OAuth2Validator, RequestValidator):
    ...
    def validate_bearer_token(self, token, scopes, request):
        ...
        try:
            token_object = JWTUtils.decode_access_token(token)
    ...
    def validate_refresh_token(self, refresh_token, client, request, *args, **kwargs):
        ...
        token_object = JWTUtils.decode_refresh_token(refresh_token)
        refresh_token = token_object["token"]
